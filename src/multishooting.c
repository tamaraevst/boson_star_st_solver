...
void    append4Data     (const char*, double, double, double, double);
int    calcExtAsym      ();
void    calcIso         ();
void    calcMass        ();
double  calcRadius      ();
...
void append4Data(const char* ofil, double x, double y, double z, double q)
  {
  FILE* ofp;
  ...
  fprintf(ofp, "%22.16g   %22.16g   %22.16g   %22.16g\n", x, y, z, q);
