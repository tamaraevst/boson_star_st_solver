/*
Complete routine for finding solutions for the massless case of BSs in ST theory.
*/
...
int main(int argc, char* argv[])
  ...
  out_final_model(par.A0, par.phigrav0, omBS, mBS, CBS, rBS, "final_model_data.dat");  
  out_joint(star.r, star.A, star.phigrav, star.X, star.Phi, star.Psi0, star.eta, star.m, 0, par.nint-1, "joint_profiles.dat");
